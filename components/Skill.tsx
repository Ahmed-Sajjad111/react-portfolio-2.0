    ...
    return (
        <div className='group relative flex cursor-pointer'>
            ...
            <motion.img
                ...
                className='rounded-full border border-gray-500 object-cover w-10 h-10 md:h-28 md:w-28 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out'
            />
            <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-10 w-10 md:h-28 md:w-28 xl:h-32 xl:w-32 rounded-full z-0'>
